...
Get-WinEvent -LogName System -MaxEvents ([System.Int32]::MaxValue) | Where-Object {$_.TimeCreated -gt (Get-Date).AddHours(-24)} | Out-File -FilePath "$env:C:\Users\bre\Desktop\opschallenge09last_24.txt"
...
Get-WinEvent -LogName System -MaxEvents ([System.Int32]::MaxValue) | Where-Object {$_.LevelDisplayName -eq "Error"} | Out-File -FilePath "$env:C:\Users\bre\Desktop\opschallenge09error.txt"
